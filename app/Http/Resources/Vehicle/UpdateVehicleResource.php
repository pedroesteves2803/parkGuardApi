...
/**
 * @OA\Schema(
 *     title="UpdateVehicleResource",
 *     description="Resource representation for updating a vehicle.",
 *     @OA\Property(
 *         property="status",
 *         type="boolean",
 ...
 *         property="vehicle",
 *         type="object",
 *         description="Details of the updated vehicle.",
...
class UpdateVehicleResource extends JsonResource
{
    ...
    {
        return empty($this->vehicle) ? null : $this->vehicle->licensePlate()->value() . ' atualizado!';
    }

    /**
     * Get the details of the updated vehicle.
     *
     * @return array
     */
    private function getVehicleDetails(): array
    {
        ...
        return [
            ...
            'departureTimes' => !is_null($this->vehicle->departureTimes()) ? $this->vehicle->departureTimes()->value()->format('d-m-Y H:i:s') : null,
        ];
    }
}
