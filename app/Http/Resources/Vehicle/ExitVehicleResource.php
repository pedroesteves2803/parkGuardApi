...
/**
 * @OA\Schema(
 *     title="ExitVehicleResource",
 *     description="Resource representation for exiting a vehicle.",
 *     @OA\Property(
 *         property="status",
 *         type="boolean",
 ...
 *         property="vehicle",
 *         type="object",
 *         description="Details of the vehicle that exited.",
...
class ExitVehicleResource extends JsonResource
{
    ...
    {
        return empty($this->vehicle) ? null : $this->vehicle->licensePlate()->value() . ' saiu!';
    }

    /**
     * Get the details of the exited vehicle.
     *
     * @return array
     */
